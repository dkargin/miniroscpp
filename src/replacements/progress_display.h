...
//  Revision History
//   2 Aug 2024  progress_display class was taken from boost codebase directly to MiniROS project.
//   1 Dec 2001  Add leading progress display strings (suggested by Toon Knapen)
//  20 May 2001  Introduce several static_casts<> to eliminate warning messages
//             (Fixed by Beman, reported by Herve Bronnimann)
//  12 Jan 2001  Change to inline implementation to allow use without library
//             builds. See docs for more rationale. (Beman Dawes)
//  22 Jul 1999  Name changed to .hpp
//  16 Jul 1999  Second beta
//   6 Jul 1999  Initial boost version
...
class progress_display
{
 public:
  ...
  progress_display& operator=(progress_display& other) = delete;
