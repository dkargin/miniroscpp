// Generated by gencxx from file trajectory_msgs/msg/JointTrajectoryPoint.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::trajectory_msgs::JointTrajectoryPoint_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("positions", m.positions);
