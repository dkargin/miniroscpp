// Generated by gencxx from file trajectory_msgs/msg/MultiDOFJointTrajectoryPoint.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::trajectory_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("transforms", m.transforms);
      storage.element("velocities", m.velocities);
      storage.element("accelerations", m.accelerations);
      storage.element("time_from_start", m.time_from_start);
    }
