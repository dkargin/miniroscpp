// Generated by gencxx from file trajectory_msgs/msg/JointTrajectory.msg
// DO NOT EDIT!
...
#include <trajectory_msgs/JointTrajectoryPoint.hxx>
...
struct JointTrajectory_
{
  ...
  typedef std::shared_ptr< ::trajectory_msgs::JointTrajectory_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::trajectory_msgs::JointTrajectory_<ContainerAllocator> const> ConstPtr;

}; // struct JointTrajectory_

typedef ::trajectory_msgs::JointTrajectory_<std::allocator<void> > JointTrajectory;

typedef std::shared_ptr< ::trajectory_msgs::JointTrajectory > JointTrajectoryPtr;
typedef std::shared_ptr< ::trajectory_msgs::JointTrajectory const> JointTrajectoryConstPtr;
...
{
miniros::message_operations::Printer< ::trajectory_msgs::JointTrajectory_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::trajectory_msgs::JointTrajectory_<ContainerAllocator> >
  {
