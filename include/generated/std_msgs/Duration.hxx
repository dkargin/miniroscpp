// Generated by gencxx from file std_msgs/msg/Duration.msg
// DO NOT EDIT!
...
struct Duration_
{
  ...
  (void)_alloc;
   ...
   typedef miniros::Duration _data_type;
  _data_type data;
...
{
miniros::message_operations::Printer< ::std_msgs::Duration_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::Duration_<ContainerAllocator> >
  {
...
struct Printer< ::std_msgs::Duration_<ContainerAllocator> >
{
  ...
  {
    s << indent << "data: ";
    Printer<miniros::Duration>::stream(s, indent + "  ", v.data);
  }
};
