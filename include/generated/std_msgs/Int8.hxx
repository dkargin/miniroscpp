// Generated by gencxx from file std_msgs/msg/Int8.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::std_msgs::Int8_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::Int8_<ContainerAllocator> >
  {
