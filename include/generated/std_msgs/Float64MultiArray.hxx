// Generated by gencxx from file std_msgs/msg/Float64MultiArray.msg
// DO NOT EDIT!
...
#include <std_msgs/MultiArrayLayout.hxx>
...
{
miniros::message_operations::Printer< ::std_msgs::Float64MultiArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::Float64MultiArray_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("layout", m.layout);
