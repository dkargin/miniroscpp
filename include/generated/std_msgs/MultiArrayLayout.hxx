// Generated by gencxx from file std_msgs/msg/MultiArrayLayout.msg
// DO NOT EDIT!
...
#include <std_msgs/MultiArrayDimension.hxx>
...
{
miniros::message_operations::Printer< ::std_msgs::MultiArrayLayout_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::MultiArrayLayout_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("dim", m.dim);
      storage.element("data_offset", m.data_offset);
    }
