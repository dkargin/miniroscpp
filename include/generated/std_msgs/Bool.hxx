// Generated by gencxx from file std_msgs/msg/Bool.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::Bool_<ContainerAllocator> >
  {
