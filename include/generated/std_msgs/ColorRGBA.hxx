// Generated by gencxx from file std_msgs/msg/ColorRGBA.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::std_msgs::ColorRGBA_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::ColorRGBA_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("r", m.r);
      storage.element("g", m.g);
      storage.element("b", m.b);
