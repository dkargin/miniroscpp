// Generated by gencxx from file std_msgs/msg/UInt8MultiArray.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::std_msgs::UInt8MultiArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::UInt8MultiArray_<ContainerAllocator> >
  {
