// Generated by gencxx from file std_msgs/msg/UInt16MultiArray.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::std_msgs::UInt16MultiArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_msgs::UInt16MultiArray_<ContainerAllocator> >
  {
