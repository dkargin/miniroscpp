// Generated by gencxx from file visualization_msgs/msg/ImageMarker.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::visualization_msgs::ImageMarker_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::visualization_msgs::ImageMarker_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("position", m.position);
      storage.element("scale", m.scale);
      storage.element("outline_color", m.outline_color);
      storage.element("filled", m.filled);
      storage.element("fill_color", m.fill_color);
      storage.element("lifetime", m.lifetime);
      storage.element("points", m.points);
      storage.element("outline_colors", m.outline_colors);
    }
