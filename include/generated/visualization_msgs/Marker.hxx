// Generated by gencxx from file visualization_msgs/msg/Marker.msg
// DO NOT EDIT!
...
struct Marker_
{
  ...
  _color_type color;
   ...
   typedef miniros::Duration _lifetime_type;
...
{
miniros::message_operations::Printer< ::visualization_msgs::Marker_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::visualization_msgs::Marker_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("ns", m.ns);
      storage.element("id", m.id);
      storage.element("type", m.type);
      storage.element("action", m.action);
      storage.element("pose", m.pose);
      storage.element("scale", m.scale);
      storage.element("color", m.color);
      storage.element("lifetime", m.lifetime);
      storage.boolean("frame_locked", m.frame_locked);
      storage.element("points", m.points);
      storage.element("colors", m.colors);
      storage.element("text", m.text);
      storage.element("mesh_resource", m.mesh_resource);
      storage.boolean("mesh_use_embedded_materials", m.mesh_use_embedded_materials);
    }
...
struct Printer< ::visualization_msgs::Marker_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::visualization_msgs::Marker_<ContainerAllocator>& v)
  {
    ...
    s << indent << "lifetime: ";
    Printer<miniros::Duration>::stream(s, indent + "  ", v.lifetime);
