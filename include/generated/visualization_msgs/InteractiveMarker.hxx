// Generated by gencxx from file visualization_msgs/msg/InteractiveMarker.msg
// DO NOT EDIT!
...
#include <visualization_msgs/MenuEntry.hxx>
#include <visualization_msgs/InteractiveMarkerControl.hxx>
...
{
miniros::message_operations::Printer< ::visualization_msgs::InteractiveMarker_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::visualization_msgs::InteractiveMarker_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("description", m.description);
      storage.element("scale", m.scale);
      storage.element("menu_entries", m.menu_entries);
      storage.element("controls", m.controls);
    }
