// Generated by gencxx from file visualization_msgs/msg/MenuEntry.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::visualization_msgs::MenuEntry_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::visualization_msgs::MenuEntry_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("id", m.id);
      storage.element("parent_id", m.parent_id);
      storage.element("title", m.title);
      storage.element("command", m.command);
      storage.element("command_type", m.command_type);
    }
