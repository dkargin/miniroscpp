// Generated by gencxx from file visualization_msgs/msg/InteractiveMarkerFeedback.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::visualization_msgs::InteractiveMarkerFeedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::visualization_msgs::InteractiveMarkerFeedback_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("client_id", m.client_id);
      storage.element("marker_name", m.marker_name);
      storage.element("control_name", m.control_name);
      storage.element("event_type", m.event_type);
      storage.element("pose", m.pose);
      storage.element("menu_entry_id", m.menu_entry_id);
      storage.element("mouse_point", m.mouse_point);
      storage.boolean("mouse_point_valid", m.mouse_point_valid);
    }
