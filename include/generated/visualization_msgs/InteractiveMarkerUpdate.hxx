// Generated by gencxx from file visualization_msgs/msg/InteractiveMarkerUpdate.msg
// DO NOT EDIT!
...
#include <visualization_msgs/InteractiveMarker.hxx>
#include <visualization_msgs/InteractiveMarkerPose.hxx>
...
{
miniros::message_operations::Printer< ::visualization_msgs::InteractiveMarkerUpdate_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::visualization_msgs::InteractiveMarkerUpdate_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("server_id", m.server_id);
      storage.element("seq_num", m.seq_num);
      storage.element("type", m.type);
      storage.element("markers", m.markers);
      storage.element("poses", m.poses);
      storage.element("erases", m.erases);
    }
