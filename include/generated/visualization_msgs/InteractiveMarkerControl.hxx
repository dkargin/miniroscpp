// Generated by gencxx from file visualization_msgs/msg/InteractiveMarkerControl.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::visualization_msgs::InteractiveMarkerControl_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("orientation_mode", m.orientation_mode);
      storage.element("interaction_mode", m.interaction_mode);
      storage.boolean("always_visible", m.always_visible);
      storage.element("markers", m.markers);
      storage.boolean("independent_marker_orientation", m.independent_marker_orientation);
