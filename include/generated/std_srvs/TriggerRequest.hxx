// Generated by gencxx from file std_srvs/srv/Trigger.srv
// DO NOT EDIT!
...
struct TriggerRequest_
{
  ...
  typedef std::shared_ptr< ::std_srvs::TriggerRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::std_srvs::TriggerRequest_<ContainerAllocator> const> ConstPtr;

}; // struct TriggerRequest_

typedef ::std_srvs::TriggerRequest_<std::allocator<void> > TriggerRequest;

typedef std::shared_ptr< ::std_srvs::TriggerRequest > TriggerRequestPtr;
typedef std::shared_ptr< ::std_srvs::TriggerRequest const> TriggerRequestConstPtr;
...
{
miniros::message_operations::Printer< ::std_srvs::TriggerRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_srvs::TriggerRequest_<ContainerAllocator> >
  {
