...
struct SetBoolResponse_
{
  ...
  typedef std::shared_ptr< ::std_srvs::SetBoolResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::std_srvs::SetBoolResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SetBoolResponse_

typedef ::std_srvs::SetBoolResponse_<std::allocator<void> > SetBoolResponse;

typedef std::shared_ptr< ::std_srvs::SetBoolResponse > SetBoolResponsePtr;
typedef std::shared_ptr< ::std_srvs::SetBoolResponse const> SetBoolResponseConstPtr;
...
{
miniros::message_operations::Printer< ::std_srvs::SetBoolResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_srvs::SetBoolResponse_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.boolean("success", m.success);
