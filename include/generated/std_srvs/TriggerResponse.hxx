...
struct TriggerResponse_
{
  ...
  typedef std::shared_ptr< ::std_srvs::TriggerResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::std_srvs::TriggerResponse_<ContainerAllocator> const> ConstPtr;

}; // struct TriggerResponse_

typedef ::std_srvs::TriggerResponse_<std::allocator<void> > TriggerResponse;

typedef std::shared_ptr< ::std_srvs::TriggerResponse > TriggerResponsePtr;
typedef std::shared_ptr< ::std_srvs::TriggerResponse const> TriggerResponseConstPtr;
...
{
miniros::message_operations::Printer< ::std_srvs::TriggerResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::std_srvs::TriggerResponse_<ContainerAllocator> >
  {
