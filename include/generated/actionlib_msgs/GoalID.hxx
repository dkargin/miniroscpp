// Generated by gencxx from file actionlib_msgs/msg/GoalID.msg
// DO NOT EDIT!
...
struct GoalID_
{
  ...
  typedef std::shared_ptr< ::actionlib_msgs::GoalID_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::actionlib_msgs::GoalID_<ContainerAllocator> const> ConstPtr;

}; // struct GoalID_

typedef ::actionlib_msgs::GoalID_<std::allocator<void> > GoalID;

typedef std::shared_ptr< ::actionlib_msgs::GoalID > GoalIDPtr;
typedef std::shared_ptr< ::actionlib_msgs::GoalID const> GoalIDConstPtr;
...
{
miniros::message_operations::Printer< ::actionlib_msgs::GoalID_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::actionlib_msgs::GoalID_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("stamp", m.stamp);
