// Generated by gencxx from file actionlib_msgs/msg/GoalStatusArray.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::actionlib_msgs::GoalStatusArray_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("status_list", m.status_list);
    }
