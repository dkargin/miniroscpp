// Generated by gencxx from file actionlib_msgs/msg/GoalStatus.msg
// DO NOT EDIT!
...
struct GoalStatus_
{
  ...
  typedef std::shared_ptr< ::actionlib_msgs::GoalStatus_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::actionlib_msgs::GoalStatus_<ContainerAllocator> const> ConstPtr;

}; // struct GoalStatus_

typedef ::actionlib_msgs::GoalStatus_<std::allocator<void> > GoalStatus;

typedef std::shared_ptr< ::actionlib_msgs::GoalStatus > GoalStatusPtr;
typedef std::shared_ptr< ::actionlib_msgs::GoalStatus const> GoalStatusConstPtr;
...
{
miniros::message_operations::Printer< ::actionlib_msgs::GoalStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::actionlib_msgs::GoalStatus_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("goal_id", m.goal_id);
