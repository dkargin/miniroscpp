// Generated by gencxx from file sensor_msgs/msg/RegionOfInterest.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::RegionOfInterest_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("x_offset", m.x_offset);
      storage.element("y_offset", m.y_offset);
      storage.element("height", m.height);
      storage.element("width", m.width);
      storage.boolean("do_rectify", m.do_rectify);
    }
