// Generated by gencxx from file sensor_msgs/msg/Illuminance.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::Illuminance_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::Illuminance_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("illuminance", m.illuminance);
