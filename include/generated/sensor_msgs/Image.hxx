// Generated by gencxx from file sensor_msgs/msg/Image.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::Image_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("encoding", m.encoding);
      storage.element("is_bigendian", m.is_bigendian);
      storage.element("step", m.step);
