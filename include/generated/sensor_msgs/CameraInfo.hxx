// Generated by gencxx from file sensor_msgs/msg/CameraInfo.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::CameraInfo_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("distortion_model", m.distortion_model);
      storage.element("D", m.D);
      storage.element("K", m.K);
      storage.element("R", m.R);
      storage.element("P", m.P);
      storage.element("binning_x", m.binning_x);
      storage.element("binning_y", m.binning_y);
      storage.element("roi", m.roi);
    }
