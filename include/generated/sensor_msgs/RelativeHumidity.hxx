// Generated by gencxx from file sensor_msgs/msg/RelativeHumidity.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("relative_humidity", m.relative_humidity);
      storage.element("variance", m.variance);
    }
