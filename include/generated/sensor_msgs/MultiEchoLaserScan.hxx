// Generated by gencxx from file sensor_msgs/msg/MultiEchoLaserScan.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("angle_min", m.angle_min);
      storage.element("angle_max", m.angle_max);
      storage.element("angle_increment", m.angle_increment);
      storage.element("time_increment", m.time_increment);
      storage.element("scan_time", m.scan_time);
      storage.element("range_min", m.range_min);
      storage.element("range_max", m.range_max);
      storage.element("ranges", m.ranges);
      storage.element("intensities", m.intensities);
    }
