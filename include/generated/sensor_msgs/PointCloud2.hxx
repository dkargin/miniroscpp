// Generated by gencxx from file sensor_msgs/msg/PointCloud2.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("height", m.height);
      storage.element("width", m.width);
      storage.element("fields", m.fields);
      storage.boolean("is_bigendian", m.is_bigendian);
      storage.element("point_step", m.point_step);
      storage.element("row_step", m.row_step);
      storage.binary("data", m.data);
      storage.boolean("is_dense", m.is_dense);
    }
