// Generated by gencxx from file sensor_msgs/msg/MultiDOFJointState.msg
// DO NOT EDIT!
...
#include <geometry_msgs/Wrench.hxx>
...
{
miniros::message_operations::Printer< ::sensor_msgs::MultiDOFJointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::MultiDOFJointState_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("twist", m.twist);
      storage.element("wrench", m.wrench);
    }
