// Generated by gencxx from file sensor_msgs/msg/Temperature.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::Temperature_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::Temperature_<ContainerAllocator> >
  {
