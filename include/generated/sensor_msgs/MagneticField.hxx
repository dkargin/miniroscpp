// Generated by gencxx from file sensor_msgs/msg/MagneticField.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::MagneticField_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::MagneticField_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("magnetic_field", m.magnetic_field);
      storage.element("magnetic_field_covariance", m.magnetic_field_covariance);
    }
