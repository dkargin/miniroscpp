// Generated by gencxx from file sensor_msgs/msg/JointState.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::JointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::JointState_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("velocity", m.velocity);
      storage.element("effort", m.effort);
    }
