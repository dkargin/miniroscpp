// Generated by gencxx from file sensor_msgs/srv/SetCameraInfo.srv
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.boolean("success", m.success);
      storage.element("status_message", m.status_message);
    }
