// Generated by gencxx from file sensor_msgs/msg/NavSatFix.msg
// DO NOT EDIT!
...
#include <sensor_msgs/NavSatStatus.hxx>
...
{
miniros::message_operations::Printer< ::sensor_msgs::NavSatFix_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::NavSatFix_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("latitude", m.latitude);
      storage.element("longitude", m.longitude);
      storage.element("altitude", m.altitude);
      storage.element("position_covariance", m.position_covariance);
      storage.element("position_covariance_type", m.position_covariance_type);
    }
