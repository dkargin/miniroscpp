// Generated by gencxx from file sensor_msgs/msg/PointField.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::PointField_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::PointField_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("name", m.name);
      storage.element("offset", m.offset);
      storage.element("datatype", m.datatype);
