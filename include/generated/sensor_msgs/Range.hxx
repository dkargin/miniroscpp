// Generated by gencxx from file sensor_msgs/msg/Range.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::Range_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::Range_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("radiation_type", m.radiation_type);
      storage.element("field_of_view", m.field_of_view);
      storage.element("min_range", m.min_range);
      storage.element("max_range", m.max_range);
      storage.element("range", m.range);
    }
