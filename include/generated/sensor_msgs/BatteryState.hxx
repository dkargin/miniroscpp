// Generated by gencxx from file sensor_msgs/msg/BatteryState.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::BatteryState_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("voltage", m.voltage);
      storage.element("temperature", m.temperature);
      storage.element("current", m.current);
      storage.element("charge", m.charge);
      storage.element("capacity", m.capacity);
      storage.element("design_capacity", m.design_capacity);
      storage.element("percentage", m.percentage);
      storage.element("power_supply_status", m.power_supply_status);
      storage.element("power_supply_health", m.power_supply_health);
      storage.element("power_supply_technology", m.power_supply_technology);
      storage.boolean("present", m.present);
      storage.element("cell_voltage", m.cell_voltage);
      storage.element("cell_temperature", m.cell_temperature);
      storage.element("location", m.location);
      storage.element("serial_number", m.serial_number);
    }
