// Generated by gencxx from file sensor_msgs/msg/NavSatStatus.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::NavSatStatus_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("status", m.status);
      storage.element("service", m.service);
    }
