// Generated by gencxx from file sensor_msgs/msg/JoyFeedback.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::JoyFeedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::JoyFeedback_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("intensity", m.intensity);
    }
