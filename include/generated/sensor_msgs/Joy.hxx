// Generated by gencxx from file sensor_msgs/msg/Joy.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::Joy_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::Joy_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("axes", m.axes);
      storage.element("buttons", m.buttons);
    }
