// Generated by gencxx from file sensor_msgs/msg/Imu.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::sensor_msgs::Imu_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::sensor_msgs::Imu_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("orientation", m.orientation);
      storage.element("orientation_covariance", m.orientation_covariance);
      storage.element("angular_velocity", m.angular_velocity);
      storage.element("angular_velocity_covariance", m.angular_velocity_covariance);
      storage.element("linear_acceleration", m.linear_acceleration);
      storage.element("linear_acceleration_covariance", m.linear_acceleration_covariance);
    }
