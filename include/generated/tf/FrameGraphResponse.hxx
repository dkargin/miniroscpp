// Generated by gencxx from file tf/srv/FrameGraph.srv
// DO NOT EDIT!
...
struct FrameGraphResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char> > _dot_graph_type;
  ...
  typedef std::shared_ptr< ::tf::FrameGraphResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::tf::FrameGraphResponse_<ContainerAllocator> const> ConstPtr;

}; // struct FrameGraphResponse_

typedef ::tf::FrameGraphResponse_<std::allocator<void> > FrameGraphResponse;

typedef std::shared_ptr< ::tf::FrameGraphResponse > FrameGraphResponsePtr;
typedef std::shared_ptr< ::tf::FrameGraphResponse const> FrameGraphResponseConstPtr;
...
{
miniros::message_operations::Printer< ::tf::FrameGraphResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf::FrameGraphResponse_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("dot_graph", m.dot_graph);
    }
...
struct Printer< ::tf::FrameGraphResponse_<ContainerAllocator> >
{
  ...
  {
    s << indent << "dot_graph: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char> >>::stream(s, indent + "  ", v.dot_graph);
  }
};
