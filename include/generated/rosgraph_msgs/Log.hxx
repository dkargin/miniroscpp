// Generated by gencxx from file rosgraph_msgs/msg/Log.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::rosgraph_msgs::Log_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("msg", m.msg);
      storage.element("file", m.file);
      storage.element("function", m.function);
      storage.element("line", m.line);
      storage.element("topics", m.topics);
    }
