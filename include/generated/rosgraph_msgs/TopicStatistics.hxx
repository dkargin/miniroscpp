// Generated by gencxx from file rosgraph_msgs/msg/TopicStatistics.msg
// DO NOT EDIT!
...
struct TopicStatistics_
{
  ...
  _node_sub_type node_sub;
   ...
   typedef miniros::Time _window_start_type;
  _window_start_type window_start;

   typedef miniros::Time _window_stop_type;
  ...
  _traffic_type traffic;
   ...
   typedef miniros::Duration _period_mean_type;
  _period_mean_type period_mean;

   typedef miniros::Duration _period_stddev_type;
  _period_stddev_type period_stddev;

   typedef miniros::Duration _period_max_type;
  _period_max_type period_max;

   typedef miniros::Duration _stamp_age_mean_type;
  _stamp_age_mean_type stamp_age_mean;

   typedef miniros::Duration _stamp_age_stddev_type;
  _stamp_age_stddev_type stamp_age_stddev;

   typedef miniros::Duration _stamp_age_max_type;
...
{
miniros::message_operations::Printer< ::rosgraph_msgs::TopicStatistics_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::rosgraph_msgs::TopicStatistics_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("topic", m.topic);
      storage.element("node_pub", m.node_pub);
      storage.element("node_sub", m.node_sub);
      storage.element("window_start", m.window_start);
      storage.element("window_stop", m.window_stop);
      storage.element("delivered_msgs", m.delivered_msgs);
      storage.element("dropped_msgs", m.dropped_msgs);
      storage.element("traffic", m.traffic);
      storage.element("period_mean", m.period_mean);
      storage.element("period_stddev", m.period_stddev);
      storage.element("period_max", m.period_max);
      storage.element("stamp_age_mean", m.stamp_age_mean);
      storage.element("stamp_age_stddev", m.stamp_age_stddev);
      storage.element("stamp_age_max", m.stamp_age_max);
    }
...
struct Printer< ::rosgraph_msgs::TopicStatistics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosgraph_msgs::TopicStatistics_<ContainerAllocator>& v)
  {
    ...
    Printer<miniros::Time>::stream(s, indent + "  ", v.window_start);
    s << indent << "window_stop: ";
    Printer<miniros::Time>::stream(s, indent + "  ", v.window_stop);
    ...
    Printer<miniros::Duration>::stream(s, indent + "  ", v.period_mean);
    s << indent << "period_stddev: ";
    Printer<miniros::Duration>::stream(s, indent + "  ", v.period_stddev);
    s << indent << "period_max: ";
    Printer<miniros::Duration>::stream(s, indent + "  ", v.period_max);
    s << indent << "stamp_age_mean: ";
    Printer<miniros::Duration>::stream(s, indent + "  ", v.stamp_age_mean);
    s << indent << "stamp_age_stddev: ";
    Printer<miniros::Duration>::stream(s, indent + "  ", v.stamp_age_stddev);
    s << indent << "stamp_age_max: ";
    Printer<miniros::Duration>::stream(s, indent + "  ", v.stamp_age_max);
  }
};
