// Generated by gencxx from file rosgraph_msgs/msg/Clock.msg
// DO NOT EDIT!
...
struct Clock_
{
  ...
  (void)_alloc;
   ...
   typedef miniros::Time _clock_type;
  _clock_type clock;
...
{
miniros::message_operations::Printer< ::rosgraph_msgs::Clock_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::rosgraph_msgs::Clock_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("clock", m.clock);
    }
...
struct Printer< ::rosgraph_msgs::Clock_<ContainerAllocator> >
{
  ...
  {
    s << indent << "clock: ";
    Printer<miniros::Time>::stream(s, indent + "  ", v.clock);
  }
};
