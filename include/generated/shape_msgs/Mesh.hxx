// Generated by gencxx from file shape_msgs/msg/Mesh.msg
// DO NOT EDIT!
...
#include <shape_msgs/MeshTriangle.hxx>
...
struct Mesh_
{
  ...
  typedef std::shared_ptr< ::shape_msgs::Mesh_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::shape_msgs::Mesh_<ContainerAllocator> const> ConstPtr;

}; // struct Mesh_

typedef ::shape_msgs::Mesh_<std::allocator<void> > Mesh;

typedef std::shared_ptr< ::shape_msgs::Mesh > MeshPtr;
typedef std::shared_ptr< ::shape_msgs::Mesh const> MeshConstPtr;
...
{
miniros::message_operations::Printer< ::shape_msgs::Mesh_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::shape_msgs::Mesh_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("triangles", m.triangles);
      storage.element("vertices", m.vertices);
    }
