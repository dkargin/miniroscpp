// Generated by gencxx from file shape_msgs/msg/MeshTriangle.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::shape_msgs::MeshTriangle_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("vertex_indices", m.vertex_indices);
    }
