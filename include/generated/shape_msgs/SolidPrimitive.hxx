// Generated by gencxx from file shape_msgs/msg/SolidPrimitive.msg
// DO NOT EDIT!
...
struct SolidPrimitive_
{
  ...
  typedef std::shared_ptr< ::shape_msgs::SolidPrimitive_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::shape_msgs::SolidPrimitive_<ContainerAllocator> const> ConstPtr;

}; // struct SolidPrimitive_

typedef ::shape_msgs::SolidPrimitive_<std::allocator<void> > SolidPrimitive;

typedef std::shared_ptr< ::shape_msgs::SolidPrimitive > SolidPrimitivePtr;
typedef std::shared_ptr< ::shape_msgs::SolidPrimitive const> SolidPrimitiveConstPtr;
...
{
miniros::message_operations::Printer< ::shape_msgs::SolidPrimitive_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::shape_msgs::SolidPrimitive_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("type", m.type);
      storage.element("dimensions", m.dimensions);
    }
