// Generated by gencxx from file test_roscpp/WithHeader.msg
// DO NOT EDIT!
...
struct WithHeader_
{
  ...
  typedef std::shared_ptr< ::test_roscpp::WithHeader_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::test_roscpp::WithHeader_<ContainerAllocator> const> ConstPtr;

}; // struct WithHeader_

typedef ::test_roscpp::WithHeader_<std::allocator<void> > WithHeader;

typedef std::shared_ptr< ::test_roscpp::WithHeader > WithHeaderPtr;
typedef std::shared_ptr< ::test_roscpp::WithHeader const> WithHeaderConstPtr;
...
{
miniros::message_operations::Printer< ::test_roscpp::WithHeader_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct KVSerializer< ::test_roscpp::WithHeader_<ContainerAllocator> >
  {
