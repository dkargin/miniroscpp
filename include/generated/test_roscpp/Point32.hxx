...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct KVSerializer< ::test_roscpp::Point32_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("x", m.x);
      storage.element("y", m.y);
      storage.element("z", m.z);
    }
