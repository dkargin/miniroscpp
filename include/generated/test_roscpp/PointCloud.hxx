// Generated by gencxx from file test_roscpp/PointCloud.msg
// DO NOT EDIT!
...
#include <test_roscpp/Point32.hxx>
#include <test_roscpp/ChannelFloat32.hxx>
...
struct PointCloud_
{
  ...
  typedef std::shared_ptr< ::test_roscpp::PointCloud_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::test_roscpp::PointCloud_<ContainerAllocator> const> ConstPtr;

}; // struct PointCloud_

typedef ::test_roscpp::PointCloud_<std::allocator<void> > PointCloud;

typedef std::shared_ptr< ::test_roscpp::PointCloud > PointCloudPtr;
typedef std::shared_ptr< ::test_roscpp::PointCloud const> PointCloudConstPtr;
...
{
miniros::message_operations::Printer< ::test_roscpp::PointCloud_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct KVSerializer< ::test_roscpp::PointCloud_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("pts", m.pts);
      storage.element("chan", m.chan);
    }
