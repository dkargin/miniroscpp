// Generated by gencxx from file diagnostic_msgs/msg/KeyValue.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::diagnostic_msgs::KeyValue_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::diagnostic_msgs::KeyValue_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("key", m.key);
      storage.element("value", m.value);
    }
