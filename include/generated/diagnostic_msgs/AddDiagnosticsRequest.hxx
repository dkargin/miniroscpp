// Generated by gencxx from file diagnostic_msgs/srv/AddDiagnostics.srv
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::diagnostic_msgs::AddDiagnosticsRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::diagnostic_msgs::AddDiagnosticsRequest_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("load_namespace", m.load_namespace);
    }
