// Generated by gencxx from file stereo_msgs/msg/DisparityImage.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::stereo_msgs::DisparityImage_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("image", m.image);
      storage.element("f", m.f);
      storage.element("T", m.T);
      storage.element("valid_window", m.valid_window);
      storage.element("min_disparity", m.min_disparity);
      storage.element("max_disparity", m.max_disparity);
      storage.element("delta_d", m.delta_d);
    }
