// Generated by gencxx from file geometry_msgs/msg/Inertia.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::geometry_msgs::Inertia_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::Inertia_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("m", m.m);
      storage.element("com", m.com);
      storage.element("ixx", m.ixx);
      storage.element("ixy", m.ixy);
      storage.element("ixz", m.ixz);
      storage.element("iyy", m.iyy);
      storage.element("iyz", m.iyz);
      storage.element("izz", m.izz);
    }
