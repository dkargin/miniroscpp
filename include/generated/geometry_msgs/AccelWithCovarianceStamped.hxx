// Generated by gencxx from file geometry_msgs/msg/AccelWithCovarianceStamped.msg
// DO NOT EDIT!
...
#include <geometry_msgs/AccelWithCovariance.hxx>
...
{
miniros::message_operations::Printer< ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("accel", m.accel);
    }
