// Generated by gencxx from file geometry_msgs/msg/Transform.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::geometry_msgs::Transform_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::Transform_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("translation", m.translation);
      storage.element("rotation", m.rotation);
    }
