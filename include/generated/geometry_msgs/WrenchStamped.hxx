// Generated by gencxx from file geometry_msgs/msg/WrenchStamped.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::geometry_msgs::WrenchStamped_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::WrenchStamped_<ContainerAllocator> >
  {
