// Generated by gencxx from file geometry_msgs/msg/InertiaStamped.msg
// DO NOT EDIT!
...
#include <geometry_msgs/Inertia.hxx>
...
{
miniros::message_operations::Printer< ::geometry_msgs::InertiaStamped_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::InertiaStamped_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("inertia", m.inertia);
    }
