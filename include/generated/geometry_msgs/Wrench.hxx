// Generated by gencxx from file geometry_msgs/msg/Wrench.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::Wrench_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("force", m.force);
      storage.element("torque", m.torque);
    }
