// Generated by gencxx from file geometry_msgs/msg/Vector3Stamped.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("vector", m.vector);
    }
