// Generated by gencxx from file geometry_msgs/msg/PoseArray.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::geometry_msgs::PoseArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::PoseArray_<ContainerAllocator> >
  {
