// Generated by gencxx from file geometry_msgs/msg/QuaternionStamped.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("quaternion", m.quaternion);
    }
