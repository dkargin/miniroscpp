// Generated by gencxx from file geometry_msgs/msg/Accel.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::geometry_msgs::Accel_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::geometry_msgs::Accel_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("linear", m.linear);
      storage.element("angular", m.angular);
    }
