// Generated by gencxx from file nav_msgs/msg/MapMetaData.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::MapMetaData_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("map_load_time", m.map_load_time);
      storage.element("resolution", m.resolution);
      storage.element("width", m.width);
      storage.element("height", m.height);
      storage.element("origin", m.origin);
    }
