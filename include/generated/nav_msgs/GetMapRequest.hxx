// Generated by gencxx from file nav_msgs/srv/GetMap.srv
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::nav_msgs::GetMapRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::GetMapRequest_<ContainerAllocator> >
  {
