...
{
miniros::message_operations::Printer< ::nav_msgs::GetMapResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::GetMapResponse_<ContainerAllocator> >
  {
