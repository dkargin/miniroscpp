// Generated by gencxx from file nav_msgs/msg/GetMapActionFeedback.msg
// DO NOT EDIT!
...
#include <nav_msgs/GetMapFeedback.hxx>
...
{
miniros::message_operations::Printer< ::nav_msgs::GetMapActionFeedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::GetMapActionFeedback_<ContainerAllocator> >
  {
