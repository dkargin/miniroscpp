// Generated by gencxx from file nav_msgs/srv/GetPlan.srv
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::GetPlanRequest_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("start", m.start);
      storage.element("goal", m.goal);
      storage.element("tolerance", m.tolerance);
    }
