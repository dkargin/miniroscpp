// Generated by gencxx from file nav_msgs/msg/OccupancyGrid.msg
// DO NOT EDIT!
...
#include <nav_msgs/MapMetaData.hxx>
...
{
miniros::message_operations::Printer< ::nav_msgs::OccupancyGrid_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::OccupancyGrid_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("info", m.info);
