// Generated by gencxx from file nav_msgs/srv/SetMap.srv
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::SetMapRequest_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("map", m.map);
      storage.element("initial_pose", m.initial_pose);
    }
