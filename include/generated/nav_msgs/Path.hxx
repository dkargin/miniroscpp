// Generated by gencxx from file nav_msgs/msg/Path.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::nav_msgs::Path_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::Path_<ContainerAllocator> >
  {
