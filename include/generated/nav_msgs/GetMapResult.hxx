// Generated by gencxx from file nav_msgs/msg/GetMapResult.msg
// DO NOT EDIT!
...
{
miniros::message_operations::Printer< ::nav_msgs::GetMapResult_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::GetMapResult_<ContainerAllocator> >
  {
