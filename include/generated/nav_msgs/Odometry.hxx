// Generated by gencxx from file nav_msgs/msg/Odometry.msg
// DO NOT EDIT!
...
#include <geometry_msgs/PoseWithCovariance.hxx>
#include <geometry_msgs/TwistWithCovariance.hxx>
...
{
miniros::message_operations::Printer< ::nav_msgs::Odometry_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::Odometry_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("child_frame_id", m.child_frame_id);
