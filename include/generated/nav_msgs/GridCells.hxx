// Generated by gencxx from file nav_msgs/msg/GridCells.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::nav_msgs::GridCells_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("cell_width", m.cell_width);
      storage.element("cell_height", m.cell_height);
      storage.element("cells", m.cells);
    }
