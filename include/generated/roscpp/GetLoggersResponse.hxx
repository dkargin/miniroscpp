...
struct GetLoggersResponse_
{
  ...
  typedef std::shared_ptr< ::roscpp::GetLoggersResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::roscpp::GetLoggersResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetLoggersResponse_

typedef ::roscpp::GetLoggersResponse_<std::allocator<void> > GetLoggersResponse;

typedef std::shared_ptr< ::roscpp::GetLoggersResponse > GetLoggersResponsePtr;
typedef std::shared_ptr< ::roscpp::GetLoggersResponse const> GetLoggersResponseConstPtr;
...
{
miniros::message_operations::Printer< ::roscpp::GetLoggersResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::roscpp::GetLoggersResponse_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("loggers", m.loggers);
    }
