// Generated by gencxx from file tf2_msgs/msg/TF2Error.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::TF2Error_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("error", m.error);
      storage.element("error_string", m.error_string);
    }
