// Generated by gencxx from file tf2_msgs/msg/LookupTransformActionFeedback.msg
// DO NOT EDIT!
...
#include <tf2_msgs/LookupTransformFeedback.hxx>
...
struct LookupTransformActionFeedback_
{
  ...
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionFeedback_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct LookupTransformActionFeedback_

typedef ::tf2_msgs::LookupTransformActionFeedback_<std::allocator<void> > LookupTransformActionFeedback;

typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionFeedback > LookupTransformActionFeedbackPtr;
typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionFeedback const> LookupTransformActionFeedbackConstPtr;
...
{
miniros::message_operations::Printer< ::tf2_msgs::LookupTransformActionFeedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::LookupTransformActionFeedback_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("header", m.header);
      storage.element("status", m.status);
      storage.element("feedback", m.feedback);
    }
