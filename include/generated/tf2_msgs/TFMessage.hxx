// Generated by gencxx from file tf2_msgs/msg/TFMessage.msg
// DO NOT EDIT!
...
struct TFMessage_
{
  ...
  typedef std::shared_ptr< ::tf2_msgs::TFMessage_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::tf2_msgs::TFMessage_<ContainerAllocator> const> ConstPtr;

}; // struct TFMessage_

typedef ::tf2_msgs::TFMessage_<std::allocator<void> > TFMessage;

typedef std::shared_ptr< ::tf2_msgs::TFMessage > TFMessagePtr;
typedef std::shared_ptr< ::tf2_msgs::TFMessage const> TFMessageConstPtr;
...
{
miniros::message_operations::Printer< ::tf2_msgs::TFMessage_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::TFMessage_<ContainerAllocator> >
  {
