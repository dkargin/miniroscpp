// Generated by gencxx from file tf2_msgs/srv/FrameGraph.srv
// DO NOT EDIT!
...
struct FrameGraphRequest_
{
  ...
  typedef std::shared_ptr< ::tf2_msgs::FrameGraphRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::tf2_msgs::FrameGraphRequest_<ContainerAllocator> const> ConstPtr;

}; // struct FrameGraphRequest_

typedef ::tf2_msgs::FrameGraphRequest_<std::allocator<void> > FrameGraphRequest;

typedef std::shared_ptr< ::tf2_msgs::FrameGraphRequest > FrameGraphRequestPtr;
typedef std::shared_ptr< ::tf2_msgs::FrameGraphRequest const> FrameGraphRequestConstPtr;
...
{
miniros::message_operations::Printer< ::tf2_msgs::FrameGraphRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::FrameGraphRequest_<ContainerAllocator> >
  {
