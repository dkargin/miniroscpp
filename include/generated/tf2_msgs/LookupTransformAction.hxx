// Generated by gencxx from file tf2_msgs/msg/LookupTransformAction.msg
// DO NOT EDIT!
...
#include <tf2_msgs/LookupTransformActionGoal.hxx>
#include <tf2_msgs/LookupTransformActionResult.hxx>
#include <tf2_msgs/LookupTransformActionFeedback.hxx>
...
struct LookupTransformAction_
{
  ...
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformAction_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformAction_<ContainerAllocator> const> ConstPtr;

}; // struct LookupTransformAction_

typedef ::tf2_msgs::LookupTransformAction_<std::allocator<void> > LookupTransformAction;

typedef std::shared_ptr< ::tf2_msgs::LookupTransformAction > LookupTransformActionPtr;
typedef std::shared_ptr< ::tf2_msgs::LookupTransformAction const> LookupTransformActionConstPtr;
...
{
miniros::message_operations::Printer< ::tf2_msgs::LookupTransformAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::LookupTransformAction_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("action_goal", m.action_goal);
      storage.element("action_result", m.action_result);
      storage.element("action_feedback", m.action_feedback);
    }
