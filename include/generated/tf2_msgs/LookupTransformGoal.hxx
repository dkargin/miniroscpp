// Generated by gencxx from file tf2_msgs/msg/LookupTransformGoal.msg
// DO NOT EDIT!
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::LookupTransformGoal_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("target_frame", m.target_frame);
      storage.element("source_frame", m.source_frame);
      storage.element("source_time", m.source_time);
      storage.element("timeout", m.timeout);
      storage.element("target_time", m.target_time);
      storage.element("fixed_frame", m.fixed_frame);
      storage.boolean("advanced", m.advanced);
    }
