// Generated by gencxx from file tf2_msgs/msg/LookupTransformActionResult.msg
// DO NOT EDIT!
...
#include <tf2_msgs/LookupTransformResult.hxx>
...
struct LookupTransformActionResult_
{
  ...
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionResult_<ContainerAllocator> const> ConstPtr;

}; // struct LookupTransformActionResult_

typedef ::tf2_msgs::LookupTransformActionResult_<std::allocator<void> > LookupTransformActionResult;

typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionResult > LookupTransformActionResultPtr;
typedef std::shared_ptr< ::tf2_msgs::LookupTransformActionResult const> LookupTransformActionResultConstPtr;
...
{
miniros::message_operations::Printer< ::tf2_msgs::LookupTransformActionResult_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::LookupTransformActionResult_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      ...
      storage.element("result", m.result);
    }
