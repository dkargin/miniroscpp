// Generated by gencxx from file tf2_msgs/msg/LookupTransformResult.msg
// DO NOT EDIT!
...
struct LookupTransformResult_
{
  ...
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformResult_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::tf2_msgs::LookupTransformResult_<ContainerAllocator> const> ConstPtr;

}; // struct LookupTransformResult_

typedef ::tf2_msgs::LookupTransformResult_<std::allocator<void> > LookupTransformResult;

typedef std::shared_ptr< ::tf2_msgs::LookupTransformResult > LookupTransformResultPtr;
typedef std::shared_ptr< ::tf2_msgs::LookupTransformResult const> LookupTransformResultConstPtr;
...
{
miniros::message_operations::Printer< ::tf2_msgs::LookupTransformResult_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
namespace miniros { namespace serialization {
  ...
  template<class ContainerAllocator> struct KVSerializer< ::tf2_msgs::LookupTransformResult_<ContainerAllocator> >
  {
    template<typename Storage, typename T> inline static void allInOne(Storage& storage, T m)
    {
      storage.element("transform", m.transform);
      storage.element("error", m.error);
    }
